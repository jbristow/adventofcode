...
object Day04 : AdventOfCode() {
    ...
    private tailrec fun List<Card>.redeem(cardCounts: Map<Int, Long> = this.associate { it.id to 1L }): Map<Int, Long> {
        if (this.isEmpty()) {
            return cardCounts
        }
    ...
    private fun part2(input: List<String>) = input.toCards().redeem().values.sum()
